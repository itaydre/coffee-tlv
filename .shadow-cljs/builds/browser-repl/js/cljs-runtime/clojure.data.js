...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__12040){
...
var vec__12044 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12044,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12044,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12044,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_12188 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_12188(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_12189 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_12189(a,b);
}
});
