...
var G__12587 = (i__5770__auto___12585 + (1));
i__5770__auto___12585 = G__12587;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq12433){
var G__12434 = cljs.core.first(seq12433);
var seq12433__$1 = cljs.core.next(seq12433);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12434,seq12433__$1);
}));
...
return cljs.core.some((function (p1__12449_SHARP_){
return (p1__12449_SHARP_ === object);
}),history__$1);
});
...
(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__12457){
var vec__12458 = p__12457;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12458,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq12454){
var G__12455 = cljs.core.first(seq12454);
var seq12454__$1 = cljs.core.next(seq12454);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12455,seq12454__$1);
}));

devtools.formatters.state.seek_path_segment = (function devtools$formatters$state$seek_path_segment(var_args){
var args__5775__auto__ = [];
var len__5769__auto___12601 = arguments.length;
var i__5770__auto___12602 = (0);
while(true){
if((i__5770__auto___12602 < len__5769__auto___12601)){
args__5775__auto__.push((arguments[i__5770__auto___12602]));

var G__12603 = (i__5770__auto___12602 + (1));
i__5770__auto___12602 = G__12603;
continue;
} else {
}
break;
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__12472){
var vec__12474 = p__12472;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12474,(0),null);
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq12464){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12465,G__12466,seq12464__$2);
}));
