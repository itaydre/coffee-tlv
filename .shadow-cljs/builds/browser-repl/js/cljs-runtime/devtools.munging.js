...
var o12389 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12389["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12390 = temp__5802__auto____$1;
return (o12390["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12140__auto__ = f;
return (o__12140__auto__["toString"]).call(o__12140__auto__);
} else {
return "";
}
}catch (e12392){var _ = e12392;
return "";
}});
...
try{var o__12140__auto___12733 = t;
(o__12140__auto___12733["cljs$lang$ctorPrWriter"]).call(o__12140__auto___12733,t,writer);
}catch (e12394){var __12734 = e12394;
}
...
var char_code = (function (){var o__12140__auto__ = (new String(char$));
return (o__12140__auto__["charCodeAt"]).call(o__12140__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12140__auto__ = String;
return (o__12140__auto__["fromCharCode"]).call(o__12140__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12405 = num_code;
switch (G__12405) {
case (1):
return (185);
...
var o__12140__auto__ = String;
return (o__12140__auto__["fromCharCode"]).call(o__12140__auto__,superscript_code);
});
/**
...
}catch (e12412){var _e__12154__auto__ = e12412;
return false;
}})())){
...
var vec__12413 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12413,(0),null);
...
var G__12738 = (i__5770__auto___12737 + (1));
i__5770__auto___12737 = G__12738;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12442){
var vec__12443 = p__12442;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12443,(0),null);
...
var G__12739 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12740 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12739;
remaining_tokens = G__12740;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12435){
var G__12436 = cljs.core.first(seq12435);
var seq12435__$1 = cljs.core.next(seq12435);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12436,seq12435__$1);
}));
...
var vec__12485 = cljs.core.split_with((function (p1__12484_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12484_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12485,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12485,(1),null);
...
var vec__12494 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12494,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12494,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12742 = cljs.core.rest(remaining_tokens);
var G__12743 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12742;
name_tokens = G__12743;
continue;
} else {
...
var vec__12529 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12529,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12529,(1),null);
var vec__12534 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12534,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12534,(1),null);
var vec__12537 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12537,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12537,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12537,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12537,(3),null);
...
var vec__12554 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12554,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12554,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12554,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12554,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12554,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12554,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12561 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12561,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12561,(1),null);
var vec__12564 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12564,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12564,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12575 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12575) : devtools.munging.parse_fn_info_deep.call(null,G__12575));
})()));
}
} else {
return fn_info;
...
var G__12746 = (arity + (1));
var G__12747 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12593){
var vec__12594 = p__12593;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12605_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12605_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12606_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12606_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12614){
var vec__12615 = p__12614;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12615,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12612){
var G__12613 = cljs.core.first(seq12612);
var seq12612__$1 = cljs.core.next(seq12612);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12613,seq12612__$1);
}));
...
var map__12643 = options;
var map__12643__$1 = cljs.core.__destructure_map(map__12643);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12643__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12643__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12643__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12643__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12644 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(4),null);
...
var o__12140__auto__ = f;
return (o__12140__auto__["getBasis"]).call(o__12140__auto__);
});
/**
...
}catch (e12651){var _e__12154__auto__ = e12651;
...
var G__12759 = (obj[cljs.core.first(path)]);
var G__12760 = cljs.core.rest(path);
obj = G__12759;
path = G__12760;
continue;
} else {
...
var _STAR_ = (function (accum,p__12656){
var vec__12657 = p__12656;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12657,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12657,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12660){
var vec__12661 = p__12660;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12661,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12661,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12661,(2),null);
...
var post_process = (function (p__12666){
var vec__12667 = p__12666;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12667,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12667,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12664_SHARP_){
return (obj[cljs.core.first(p1__12664_SHARP_)]);
}),sorted_matches);
