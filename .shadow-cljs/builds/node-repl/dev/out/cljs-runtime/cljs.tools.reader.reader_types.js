...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_16947 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_16947(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_16948 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_16948(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16950 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16950(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16952 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16952(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16953 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16953(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16954 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16954(reader);
}
});
...
var G__16978 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__16979 = s.append(c);
c = G__16978;
s = G__16979;
continue;
}
